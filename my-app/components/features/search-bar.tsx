...
export function SearchBar() {
  ...
  const { data: searchData, isLoading } = useSearch(query, 300)
      ...
      <div ref={containerRef} className="relative hidden lg:block">
        {!isOpen ? (
          <Button 
            ...
            className="w-56 justify-start text-muted-foreground hover:text-foreground border-input bg-background hover:bg-accent"
          >
          ...
          <div className="w-56">
            ...
            {isOpen && query && (
              <Card className="absolute top-full left-0 right-0 mt-2 max-h-96 overflow-y-auto z-50 shadow-lg border">
